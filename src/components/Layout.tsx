  ...
  <header className="sticky top-0 z-50 bg-ink/80 backdrop-blur-md border-b border-white/10">
    <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
      <NavLink to="/" className="flex items-center gap-2 -ml-2">
        <img src="/PO_logo_icon_transparent.png" alt="PedicuresOnly Logo" className="h-20 w-auto object-contain" />
        <span className="text-xl font-display font-bold text-cream tracking-tight hidden sm:block">PedicuresOnly</span>
      </NavLink>
